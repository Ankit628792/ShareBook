...
const Signup = () => {
    ...
    const onSubmit = (data, e) => {
        ...
        if (data.password === data.cpassword) {
            ...
            setisLoading(true)
            const res = postData(data, `/api/user/signup`)
            res.then((res) => {
                ...
                <motion.div initial="hidden" animate="visible" variants={{
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="inputBx">
                            ...
                            {data.password !== data.cpassword && <p className="text-red-500">{"Password doesn't matched"}</p>}
                        </div>
                    ...
                    <ul className="sci">
                        <li><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-google" viewBox="0 0 16 16">
                        ...
                        <li><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-instagram" viewBox="0 0 16 16">
