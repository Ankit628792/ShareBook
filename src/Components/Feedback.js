                    ...
                    bg-gray-300 placeholder-black text-gray-800 outline-none focus:bg-gray-400" placeholder=" "
												...
												<div className="text-center mt-6">
													<button id="feedbackBtn"
														className="bg-yellow-500 tracking-widest text-white text-center mx-auto active:bg-yellow-400 text-lg uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1"
