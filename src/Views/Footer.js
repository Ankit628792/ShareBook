        ...
        <div className="footer w-full h-auto p-3 sm:py-10 sm:px-7 pt-20 py-5 flex items-center justify-center bg-black">
            <div className="md:w-3/4 w-full px-4 text-white flex flex-col">
                ...
                <div className="flex mt-8 flex-col md:flex-row md:justify-between">
                    <p className="w-full md:w-2/3 text-white">To get any type of help, review, any kind of information and get
                        an issue, just contact us. We are always here to help you.</p>
                    <div className="w-44 pt-6 md:pt-0">
                        <a href="/contactus"><motion.button
                ...
                <div className="flex flex-col">
                    ...
                    <p className="w-full text-center my-5 text-gray-600">Copyright © 2021 ShareBook</p>
                </div>
            </div>
        </div>
    )
