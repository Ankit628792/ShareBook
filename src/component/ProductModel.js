...
function ProductModel({ author, title, summary }) {

    console.log(summary)
    return (
        <div class="min-w-screen min-h-screen bg-yellow-300 flex items-center p-5 lg:p-10 overflow-hidden">
            <div class="w-full max-w-6xl rounded bg-white shadow-xl p-10 lg:p-20 mx-auto text-gray-800 relative md:text-left">
                <div class="md:flex items-center -mx-10">
                    <div class="w-2/3 mx-auto md:w-3/4 px-10 mb-10 md:mb-0">
                        <div class="relative">
